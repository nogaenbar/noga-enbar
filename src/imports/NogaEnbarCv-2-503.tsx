import svgPaths from "./svg-yzrtpc3c99";
    ...
    <div className="relative shrink-0 size-10" data-name="linkedin">
      <div className="absolute bottom-[-25%] left-[-20%] right-[-20%] top-[-15%]">
        <svg
          ...
          viewBox="0 0 56 56"
        >
          <g filter="url(#filter0_d_2_540)" id="linkedin">
            <rect
          ...
          <defs>
            ...
            >
              ...
              <feBlend
                ...
                mode="normal"
                result="effect1_dropShadow_2_540"
              />
              <feBlend
                in="SourceGraphic"
                in2="effect1_dropShadow_2_540"
                mode="normal"
                result="shape"
              />
            </filter>
    ...
    <div className="relative shrink-0 size-10" data-name="linkedin">
      <div className="absolute bottom-[-25%] left-[-20%] right-[-20%] top-[-15%]">
        <svg
          ...
          viewBox="0 0 56 56"
        >
          <g filter="url(#filter0_d_2_537)" id="linkedin">
            <rect
          ...
          <defs>
            ...
            >
              ...
              <feBlend
                in2="BackgroundImageFix"
                mode="normal"
                result="effect1_dropShadow_2_537"
              />
              <feBlend
                in="SourceGraphic"
                in2="effect1_dropShadow_2_537"
                mode="normal"
                result="shape"
              />
            </filter>
    ...
    <div className="relative shrink-0 size-10" data-name="linkedin">
      <div className="absolute bottom-[-25%] left-[-20%] right-[-20%] top-[-15%]">
        <svg
          ...
          viewBox="0 0 56 56"
        >
          <g filter="url(#filter0_d_2_534)" id="linkedin">
            <rect
          ...
          <defs>
            ...
            >
              ...
              <feBlend
                in2="BackgroundImageFix"
                mode="normal"
                result="effect1_dropShadow_2_534"
              />
              <feBlend
                in="SourceGraphic"
                in2="effect1_dropShadow_2_534"
                mode="normal"
                result="shape"
              />
            </filter>
